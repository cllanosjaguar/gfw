...
export const descriptions = {
  ...
  placesToWatch:
    'Explore areas of recent forest loss that pose the biggest threat to the world’s remaining forests. Updated monthly. Sign up <a href="http://connect.wri.org/l/120942/2017-12-07/3mtt5w" target="_blank" rel="noopener noreferrer">here</a> to receive an email when new Places to Watch are identified.'
};
